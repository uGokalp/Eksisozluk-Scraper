stopwords_1 = {'firma', 'bir', 'bkz', 'bana', 'den', 'btk', 'olan', 'olmayan', 'Name', 'object', 'kadar', 'sen',
               'senin', 'dtype', 'beni', 'kendi', 'bugü', 'şöyl', 've', 'de', 'gör', 'önç', 'olduk', 'a', 'acaba',
               'altı', 'altmış', 'ama', 'ancak', 'arada', 'artık', 'asla', 'aslında', 'aslında', 'ayrıca',
               ...
               'yine', 'yirmi', 'yoksa', 'yu', 'yüz', 'zaten', 'zira', 'bi', 'iyi', 'arasinda', 'ler', 'lerinde', 'k',
               'exception',
               'www', 'https', 'WWW', 'bir', 'Bir', 'da', 'bu', 've', 'için', 'ile', 'ama', 'de', 'bana', 'bile',
               'diye', 'ya', 'biz', 'dedim', 'ilk'}
